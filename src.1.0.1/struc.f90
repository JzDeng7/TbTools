...
! !============================================================
  ...
  real(dp), parameter :: b(3,3) = reshape( [scal, 0._dp, 0._dp, &
                                          0._dp,  scal, 0._dp, &
                                          0._dp, 0._dp, 0._dp], [3,3] )
  !============================================================
  ! Nearest hopping
  real(dp), parameter :: dlt_N11(3,1) = [  0.,  1., 0. ]
  real(dp), parameter :: dlt_N12(3,1) = [  0., -0., 0. ]
  real(dp), parameter :: dlt_N13(3,1) = [ -1., -0., 0. ]
  real(dp), parameter :: dlt_N14(3,1) = [ -1.,  1., 0. ]
  ! Nearest hopping
  real(dp), parameter :: dlt_N21(3,1) = [  1.,  0., 0. ]
  real(dp), parameter :: dlt_N22(3,1) = [  1., -1., 0. ]
  real(dp), parameter :: dlt_N23(3,1) = [  0., -1., 0. ]
  real(dp), parameter :: dlt_N24(3,1) = [  0.,  0., 0. ]
  !============================================================
  !
  ! Next Nearest hopping
  real(dp), parameter :: dlt_1NN(3,1) = [  0.,  1., 0. ]
  real(dp), parameter :: dlt_2NN(3,1) = [  1.,  0., 0. ]
  real(dp), parameter :: dlt_3NN(3,1) = [  0., -1., 0. ]
  real(dp), parameter :: dlt_4NN(3,1) = [ -1.,  0., 0. ]
  !============================================================
